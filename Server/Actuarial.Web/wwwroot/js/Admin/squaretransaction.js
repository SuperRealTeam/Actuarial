$(document).ready(function () {
    ...
    $(document).on('click', '.cmpl-aquaretransaction', function () {
    ...
    $(document).on('click', '.dwnld-squaretrans', function () {
        var Status = $('#status').val();
        window.location.href = siteURL.GetSquareTransactionExcel + "?" + "Status=" + Status;
    });
});
    ...
    ConfirmPaid: function (id) {
        $.ConfirmBox("", "Are you sure you want to confirm the record?", null, true, "Yes", true, null, function () {
            $.ajaxExt({
                ...
                showThrobber: true,
                url: baseUrl + siteURL.ConfirmSquareTransaction,
                data: { id: id },
...
function Paging(sender) {
    ...
    $.ajaxExt({
        ...
        url: baseUrl + siteURL.GetSquareTransactionPagingList,
